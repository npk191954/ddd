package com.smartrm.smartrmtradeservice.adapter.repository.impl;
...
import com.smartrm.smarttrade.domain.repository.OrderRepository;
...
import com.smartrm.smarttrade.infrastructure.dataobject.TradeCabinetVendingMachineDo;
import com.smartrm.smarttrade.infrastructure.dataobject.TradeSlotVendingMachineDo;
import com.smartrm.smarttrade.infrastructure.mapper.TradeCabinetVendingMachineMapper;
import com.smartrm.smarttrade.infrastructure.mapper.TradeSlotVendingMachineMapper;
...
public class TradeVendingMachineRepositoryImpl implements VendingMachineRepository {
  ...
  public static class TradeVendingMachineRepositoryAspect implements ApplicationContextAware {
    ...
    @Pointcut(
        "execution(* com.smartrm.smartrmtrade.domain.SlotVendingMachine.selectCommodity(..)) "
            + " || execution(* com.smartrm.smartrmtrade.domain.SlotVendingMachine.finishOrder(..))"
            + " || execution(* com.smartrm.smartrmtrade.domain.SlotVendingMachine.cancelOrder(..)) "
