...
public class TradeVendingMachineRepositoryImpl implements VendingMachineRepository {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(TradeVendingMachineRepositoryImpl.class);
    ...
    public SlotVendingMachine getSlotVendingMachineById(long id) {
        ...
        SlotVendingMachine machine = SlotVendingMachine.Builder().machineId(slotVendingMachineDo.getMachineId())
                .state(SlotVendingMachineState.of(slotVendingMachineDo.getState())).curOrder(curOrder)
                .eventBus(eventBus).version(slotVendingMachineDo.getVersion()).build();
        return machine;
    }
    ...
    public CabinetVendingMachine getCabinetVendingMachineById(long id) {
        ...
        CabinetVendingMachine machine = CabinetVendingMachine.Builder().machineId(id)
                .state(CabinetDoorState.of(machineDo.getState())).curUserOpenId(machineDo.getCurUserOpenId()).build();
    ...
    public static class TradeVendingMachineRepositoryAspect implements ApplicationContextAware {
        ...
        @Pointcut("execution(* com.smartrm.smartrmtrade.trade.domain.SlotVendingMachine.selectCommodity(..)) "
        ...
        @Pointcut("execution(* com.smartrm.smartrmtrade.trade.domain.CabinetVendingMachine.open(..)) "
