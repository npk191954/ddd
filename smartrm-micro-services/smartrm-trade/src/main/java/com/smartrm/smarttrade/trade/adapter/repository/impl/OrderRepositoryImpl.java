...
import com.smartrm.smarttrade.trade.domain.OrderState;
...
import com.smartrm.smarttrade.trade.infrastructure.dataobject.OrderDo;
import com.smartrm.smarttrade.trade.infrastructure.dataobject.StockedCommodityDo;
import com.smartrm.smarttrade.trade.infrastructure.mapper.OrderMapper;
...
//    @Pointcut("execution(* com.smartrm.smartrmtrade.trade.domain.Order.cancel(..)) "
//        + "|| execution(* com.smartrm.smartrmtrade.trade.domain.Order.succeed(..)) "
//        + "|| execution(* com.smartrm.smartrmtrade.trade.domain.Order.setPaymentId(..))")
