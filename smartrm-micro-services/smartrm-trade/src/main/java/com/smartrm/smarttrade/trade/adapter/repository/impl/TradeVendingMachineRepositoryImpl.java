package com.smartrm.smarttrade.trade.adapter.repository.impl;
...
import com.smartrm.smarttrade.trade.domain.share.CabinetDoorState;
import com.smartrm.smarttrade.trade.infrastructure.dataobject.TradeCabinetVendingMachineDo;
import com.smartrm.smarttrade.trade.infrastructure.dataobject.TradeSlotVendingMachineDo;
import com.smartrm.smarttrade.trade.infrastructure.mapper.TradeCabinetVendingMachineMapper;
import com.smartrm.smarttrade.trade.infrastructure.mapper.TradeSlotVendingMachineMapper;
...
public class TradeVendingMachineRepositoryImpl implements VendingMachineRepository {
  ...
  public static class TradeVendingMachineRepositoryAspect implements ApplicationContextAware {
    ...
    @Pointcut(
        "execution(* com.smartrm.smarttrade.trade.domain.SlotVendingMachine.selectCommodity(..)) "
            + " || execution(* com.smartrm.smarttrade.trade.domain.SlotVendingMachine.finishOrder(..))"
            + " || execution(* com.smartrm.smarttrade.trade.domain.SlotVendingMachine.cancelOrder(..)) "
            + " || execution(* com.smartrm.smarttrade.trade.domain.SlotVendingMachine.ready(..))")
    private void slotUpdate() {

    }

    @Pointcut(
        "execution(* com.smartrm.smarttrade.trade.domain.CabinetVendingMachine.open(..)) "
            + "|| execution(* com.smartrm.smarttrade.trade.domain.CabinetVendingMachine.onLocked(..))")
